...
class Register extends Component {
  ...
  render() {
    const { name, email, password, showSubmitError, errorMsg, showPassword } = this.state;
    return (
      <div className="auth-container">
        <h1 className="text-3xl font-bold mb-6 text-lime-400">Register</h1>
        ...
        <p className="mt-4 text-sm text-gray-400">
          Already have an account? <Link to="/login" className="text-lime-400 hover:underline">Login here</Link>
        </p>
      </div>
    );
  }
